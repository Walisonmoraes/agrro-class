...
import { Plus, Search, MapPin, X, Save, Edit2, Trash2, Calendar } from 'lucide-react';
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-slate-500 font-medium">Gerencie as fazendas e pontos de embarque</p>
                </div>
              </div>
            </div>
      ...
      <div className="bg-white rounded-3xl border border-slate-200/60 shadow-lg shadow-slate-200/25 overflow-hidden">
        <div className="p-8 border-b border-slate-200/60">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-2xl font-bold text-slate-900">Lista de Fazendas</h2>
              <p className="text-slate-500 mt-1">Todas as fazendas e pontos de embarque cadastrados</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-8 border-b border-slate-200/60">
          <div className="relative flex-1 max-w-md">
            ...
            <input 
              ...
              className="w-full pl-12 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl outline-none focus:border-green-500 transition-all text-sm"
              value={searchTerm}
