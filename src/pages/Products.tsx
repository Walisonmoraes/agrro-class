...
import { Plus, Search, Package, X, Save, Trash2, Calendar } from 'lucide-react';
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-slate-500 font-medium">Cadastre os tipos de grãos para classificação</p>
                </div>
              </div>
            </div>
