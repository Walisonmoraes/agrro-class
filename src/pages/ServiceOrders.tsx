...
import { Plus, Search, Clock, CheckCircle2, AlertCircle, Receipt, X, Save, Edit, Trash2, Eye, Calendar, FileText } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50/30">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-slate-500 font-medium">Gerencie suas ordens de serviço e laudos</p>
                </div>
              </div>
            </div>
      ...
      <div className="bg-white rounded-3xl border border-slate-200/60 shadow-lg shadow-slate-200/25 p-8">
        <div className="flex flex-col lg:flex-row gap-6">
          <div className="flex-1">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-4 bg-slate-50 border border-slate-200 rounded-2xl outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 transition-all text-slate-900 placeholder-slate-400"
                value={searchTerm}
          ...
          <select
            className="px-6 py-4 bg-slate-50 border border-slate-200 rounded-2xl outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 transition-all text-slate-900 font-medium"
            value={statusFilter}
        ...
        <div className="p-8 border-b border-slate-200/60">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-slate-500 mt-1">Lista completa de todas as ordens de serviço registradas</p>
            </div>
          </div>
        </div>
      </div>
