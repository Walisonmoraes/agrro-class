...
CREATE POLICY "Users can view destinations" ON destinations FOR SELECT USING (true);
CREATE POLICY "Users can create destinations" ON destinations FOR INSERT WITH CHECK (true);
CREATE POLICY "Users can update destinations" ON destinations FOR UPDATE USING (true);

CREATE POLICY "Users can view embarkation_points" ON embarkation_points FOR SELECT USING (true);
CREATE POLICY "Users can create embarkation_points" ON embarkation_points FOR INSERT WITH CHECK (true);
CREATE POLICY "Users can update embarkation_points" ON embarkation_points FOR UPDATE USING (true);

CREATE POLICY "Users can view classification_results" ON classification_results FOR SELECT USING (true);
CREATE POLICY "Users can create classification_results" ON classification_results FOR INSERT WITH CHECK (true);
CREATE POLICY "Users can update classification_results" ON classification_results FOR UPDATE USING (true);

CREATE POLICY "Users can view bills" ON bills FOR SELECT USING (true);
CREATE POLICY "Users can create bills" ON bills FOR INSERT WITH CHECK (true);
